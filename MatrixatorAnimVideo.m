...
% nFrames = 120 % Uncomment if you are willing to generate 120 frames (Previous version)
%{
...
if (exist("Rendered_imgs", "dir")~=7)
    disp("Message. 'Rendered_imgs' isn't in current folder. Creating folder...");
...
if nFrames>73
	for frame = 73:nFrames %72+48=120
		lineStart = Index*step-frame*step;
		lineEnd   = lineStart + step*(ResY-1);
